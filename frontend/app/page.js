              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="mt-6 bg-blue-50 border border-blue-200 p-4 rounded-lg">
                  <p className="text-sm text-blue-800">
                    ℹ️ <strong>Prophet Nedir?</strong> Facebook tarafından geliştirilen, mevsimsellik ve trend değişimlerini otomatik tespit eden gelişmiş bir tahmin algoritmasıdır.
                  </p>
                </div>
              </div>
            )}
